                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        $get = mysqli_query(
                                            $koneksi,
                                            "SELECT * from detail_pesanan p, produk pr WHERE p.id_produk=pr.id_produk AND id_pesanan='$idp'");
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Achmad Nur Rozikin 2024</div>
                        </div>
                    </div>
                </footer>
            </div>
